...
## Euro-Office Contribution Policy
...
- **[Contribution Guidelines](https://github.com/Euro-Office/.github/blob/main/CONTRIBUTING.md)** - covering testing requirements, sign-off, license headers, and the review process. These apply in full to all contributions regardless of how they were produced.
